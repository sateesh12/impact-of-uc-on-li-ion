...
h0 = figure('Color',figure_color, ...
   'Name',['Energy Usage Figure--',advisor_ver('info')], ...
   'Renderer','zbuffer',...
   'menubar','none',...
	'numbertitle','off',...
   'ResizeFcn','gui_size',...
...
if evalin('base','exist(''mc_trq_out_a'')')
   ...
   if evalin('base','exist(''ess_pwr_out_a'')')...
           & evalin('base','ess_on')...
           & evalin('base','exist(''ess_loss_kj'')')
      ...
      ess_stored_kj=evalin('base','ess_stored_kj');
       ...
       if evalin('base','ess_on')
           disp('Warning:  Not enough information to include ess in energy use figure');
       end
      ess_in_kj=NaN;
      ess_out_kj=NaN;
      ess_loss_kj=NaN;
...
case 'loss_plot'
   h0 = figure('Color',[.8 .8 .8], ...
      'Name',['Energy loss plot--',advisor_ver('info')], ...
      'Renderer','zbuffer',...
      'menubar','none',...
      'numbertitle','off',...
...
case 'regen_plot'
   h0 = figure('Color',[.8 .8 .8], ...
      'Name',['Energy loss in regen plot--',advisor_ver('info')], ...
      'Renderer','zbuffer',...
      'menubar','none',...
      'numbertitle','off',...
      'Position',[1 1 700 300],...
