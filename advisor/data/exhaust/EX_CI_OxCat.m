% ADVISOR data file:  EX_CI_OxCat.m
%
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ex_description='Oxidation catalyst, tested at ORNL';
...
disp(['Data loaded: EX_CI_OxCat - ',ex_description])
...
% The HC, CO, and NOx removal efficiencies are hard-coded in the lib_exhaust for
% the NOx Absorber
