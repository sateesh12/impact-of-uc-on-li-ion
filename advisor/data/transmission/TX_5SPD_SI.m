% ADVISOR data file:  TX_5SPD_SI.m
%
...
tx_version=2003;
disp('Data Loaded: manual 5-speed transmission--especially for SI engines');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% INITIALIZE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
gb_ratio=[3.25  1.81  1.21  0.86  0.64]*4.06; % ~'92 Saturn 88-hp 1.9-L SOHC
%gb_ratio=[3.46 1.94 1.29 0.97 0.81]*3.67; % '97 Jetta 115-hp 2.0-L SOHC
gb_gears_num=5;
