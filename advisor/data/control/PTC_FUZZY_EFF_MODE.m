% ADVISOR data file:  PTC_FUZZY_EFF_MODE.m
%
% Data source:
%
% Data confirmation:
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ptc_description='Fuzzy Logic controller - Efficiency mode operation';
...
disp(['Data loaded: PTC_FUZZY_EFF_MODE - ',ptc_description])
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% EFFICIENCY MODE
% Set the mode to operate near peak efficiency of the IC Engine
% 1=> FUEL LIMITING MODE; 0=> PEAK EFFIENCY MODE
cs_fuzzy_fuel_mode=0; % (--)
