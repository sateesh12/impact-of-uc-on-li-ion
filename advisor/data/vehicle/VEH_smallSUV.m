% ADVISOR data file:  VEH_smallSUV.m
%
% Data source:
%
% Data confirmation:
%
% Notes:  Defines road load parameters for a real small SUV.
% 
% Created on: 10/03/02
...
% FILE ID INFO
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
veh_description='Real small SUV';
...
disp(['Data loaded: VEH_smallSUV - ',veh_description])
...
%		The actual average vehicle mass of this small SUV is 1508 kg.
%		The glider mass below is just an estimate.
veh_glider_mass=1141; % (kg), vehicle mass w/o propulsion system (fuel converter, exhaust aftertreatment, transmission)
veh_CD=0.35;  % (--), estimated.  Not based on data for this specific vehicle.  Coefficient of aerodynamic drag
...
veh_front_wt_frac=1-0.55;  % (--), Fraction of vehicle weight on front axle when standing still.
...
veh_wheelbase=2.62;	% (m), vehicle wheelbase, from center of front tire patch to center of rear patch.
