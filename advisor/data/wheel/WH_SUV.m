...
disp(['Data loaded: WH_SUV - ',wh_description])
...
wh_1st_rrc=0.012; % (--), rolling resistance coefficient, taken from VEH_SUV files
wh_2nd_rrc=0; % (s/m)
