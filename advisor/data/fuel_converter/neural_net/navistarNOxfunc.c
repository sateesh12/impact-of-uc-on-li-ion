#ifndef navistarNOxfunc_c
#define navistarNOxfunc_c
/* Insert this code into your C program to fire the 
   C:\NeuroShell 2\Nav Pos NOx (04-05-02) network */
...
/* 
% Neural Network Mex file for Use with ADVISOR: navistarNOxfunc.c
%
...
void navistarNOxfunc(double *inarray, double *outarray)
{
 double netsum;
 double feature2[20];
 double feature3[20];
